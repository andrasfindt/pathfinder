...
java -Xmx1g -Dmaven.multiModuleProjectDirectory=${source_home} ${DEBUG} -Dmaven.home=${mvn_exec} -Dclassworlds.conf=${mvn_conf} -Dfile.encoding=UTF-8 -classpath ${mvn_classpath} clean compile exec:java > run.log